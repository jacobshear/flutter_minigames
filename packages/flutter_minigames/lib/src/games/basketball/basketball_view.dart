...
class BasketballView {
  ...
  final List<BasketballBallView> balls;
...
class _CourtPainter {
  ...
  void _paintShadow(BasketballBallView ball) {
  ...
  void _addBall(Scene3 scene, BasketballBallView ball) {
    if (ball.opacity <= 0) return;
