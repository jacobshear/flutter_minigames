...
import 'package:example_app/screens/eight_ball_play_screen.dart';

void main() {
  testWidgets('8-ball play screen builds, runs, and restarts', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: EightBallPlayScreen()),
    );
    ...
    expect(find.text('8-Ball'), findsOneWidget);
    expect(find.text('New game'), findsOneWidget);
    expect(
      find.textContaining('cue ball', findRichText: true),
      findsOneWidget,
    );
